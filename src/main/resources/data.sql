...
INSERT INTO OFFER (description, exp_date, price, start_date, title, company_id) VALUES ('Mini κρουασάν βουτύρου ALFA', '2014-11-13', 4.64, '2015-3-19', 'Mini κρουασάν βουτύρου ALFA 1+1 ΔΩΡΟ!', 1);
INSERT INTO OFFER (description, exp_date, price, start_date, title, company_id) VALUES ('Chips Lays Xtra waves', '2014-11-13', 0.83, '2015-3-19', 'Chips Lays Xtra waves 23% φθηνότερα!', 1);
INSERT INTO OFFER (description, exp_date, price, start_date, title, company_id) VALUES ('Ψωμί Πολύσπορο', '2014-11-13', 0.80, '2015-3-19', 'Έκπτωση στο πολύσπορο -0,10 λεπτά!', 2);
INSERT INTO OFFER (description, exp_date, price, start_date, title, company_id) VALUES ('Προφιτερόλ', '2014-11-13', 1.20, '2015-3-19', 'Προφιτερόλ -0,30 λεπτά!', 2);
INSERT INTO OFFER (description, exp_date, price, start_date, title, company_id) VALUES ('Laptop Dell Inspiron Q15R', '2014-11-13', 365, '2015-3-19', 'Λάπτοπ Dell Inspiron Q15R - Laptop - Core i3-2310M 2.10 GHz - 15.6" LED 20% έκπτωση!', 3);
INSERT INTO OFFER (description, exp_date, price, start_date, title, company_id) VALUES ('Asus MeMo Pad 7 ME70C', '2014-11-13', 100, '2015-3-19', 'Asus MeMo Pad 7 ME70C - Tablet 7" -30 ευρω έκπτωση!', 3);
